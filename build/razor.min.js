...
Razor.SimpleNoise.prototype.generate=function(){this.buildWhiteNoise()};Razor.SimpleNoise.prototype.buildWhiteNoise=function(){for(var a=this.contextSimple.createImageData(this.width,this.height),b=a.data,c=0;c<b.length;c+=4)b[c]=this.R,b[c+1]=255,b[c+2]=255,b[c+3]=255;this.contextNoise.putImageData(a,0,0)};
