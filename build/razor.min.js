...
0,0);for(a=4;a<=this.offscreen.width;a*=2)b=Math.floor(Math.random()*(this.offscreen.width-a)),c=Math.floor(Math.random()*(this.offscreen.height-a)),this.canvas_ctx.globalAlpha=4/a,this.canvas_ctx.drawImage(this.offscreen,b,c,a,a,0,0,this.canvas.width,this.canvas.height);this.canvas_ctx.globalAlpha=saved_alpha;document.body.appendChild(this.canvas)};Razor.Debugger=function(a,b){Razor.FPS=a;Razor.logging=b;this.gui=new dat.GUI({autoPlace:!1});this.stats=new Stats;this.stats.setMode(0);this.init()};
