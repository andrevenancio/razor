...
Razor.inherits=function(a,b){var c=function(){};c.prototype=b.prototype;a.superClass=b.prototype;a.prototype=new c;a.prototype.constructor=a};Razor.getBoundingBox=function(a){for(var b="",c=0,d=0;"object"==typeof a&&"undefined"!=typeof a.tagName;)d+=a.offsetTop,c+=a.offsetLeft,b=a.tagName.toUpperCase(),"BODY"==b&&(a=0),"object"==typeof a&&"object"==typeof a.offsetParent&&(a=a.offsetParent);return{x:c,y:d}};Razor.Vector2=function(a,b){var c=new Float32Array(2);Razor.Vector2.set(c,a||0,b||0);return c};Razor.Vector2.setX=function(a,b){a[0]=b;return this};Razor.Vector2.setY=function(a){a[1]=y;return this};Razor.Vector2.set=function(a,b,c){Razor.Vector2.setX(a,b);Razor.Vector2.setY(a,c);return this};Razor.SimpleNoise=function(a,b){this.width=a||50;this.height=b||50;this.whiteNoiseCanvas=document.createElement("canvas");this.simpleNoiseCanvas=document.createElement("canvas");this.whiteNoiseCanvas.width=this.simpleNoiseCanvas.width=this.width;this.whiteNoiseCanvas.height=this.simpleNoiseCanvas.height=this.height;this.contextNoise=this.whiteNoiseCanvas.getContext("2d");this.contextSimple=this.simpleNoiseCanvas.getContext("2d");this.saved_alpha=this.contextSimple.globalAlpha;this.init()};
Razor.SimpleNoise.prototype.init=function(){this.buildWhiteNoise();this.buildSimpleNoise()};Razor.SimpleNoise.prototype.buildWhiteNoise=function(){for(var a=this.contextSimple.createImageData(this.width,this.height),b=a.data,c=0;c<b.length;c+=4)b[c]=Math.floor(256*Math.random()),b[c+1]=Math.floor(256*Math.random()),b[c+2]=Math.floor(256*Math.random()),b[c+3]=255;this.contextNoise.putImageData(a,0,0)};
Razor.SimpleNoise.prototype.buildSimpleNoise=function(){for(var a=4;a<=this.width;a*=2){var b=Math.floor(Math.random()*(this.width-a)),c=Math.floor(Math.random()*(this.height-a));this.contextSimple.globalAlpha=4/a;this.contextSimple.drawImage(this.whiteNoiseCanvas,b,c,a,a,0,0,this.width,this.height)}this.contextSimple.globalAlpha=this.saved_alpha};Razor.SimpleNoise.prototype.getNoise=function(){return this.contextSimple.getImageData(0,0,this.width,this.height)};Razor.Debugger=function(a,b){Razor.FPS=a;Razor.logging=b;this.gui=new dat.GUI({autoPlace:!1});this.stats=new Stats;this.stats.setMode(0);this.init()};
