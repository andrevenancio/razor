...
Math.random()),d[e+2]=Math.floor(256*Math.random()),d[e+3]=255;this.contextNoise.putImageData(c,0,0);for(c=4;c<=this.width;c*=2)d=Math.floor(Math.random()*(this.width-c)),e=Math.floor(Math.random()*(this.height-c)),this.contextSimple.globalAlpha=4/c,this.contextSimple.drawImage(this.noise,d,e,c,c,0,0,this.width,this.height);this.contextSimple.globalAlpha=this.saved_alpha;return this.contextSimple.getImageData(0,0,this.width,this.height)};Razor.Debugger=function(a,b){Razor.FPS=a;Razor.logging=b;this.gui=new dat.GUI({autoPlace:!1});this.stats=new Stats;this.stats.setMode(0);this.init()};
