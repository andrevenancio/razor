...
Razor.inherits=function(a,b){var c=function(){};c.prototype=b.prototype;a.superClass=b.prototype;a.prototype=new c;a.prototype.constructor=a};Razor.getBoundingBox=function(a){for(var b="",c=0,d=0;"object"==typeof a&&"undefined"!=typeof a.tagName;)d+=a.offsetTop,c+=a.offsetLeft,b=a.tagName.toUpperCase(),"BODY"==b&&(a=0),"object"==typeof a&&"object"==typeof a.offsetParent&&(a=a.offsetParent);return{x:c,y:d}};Razor.Vector2=function(a,b){var c=new Float32Array(2);Razor.Vector2.set(c,a||0,b||0);return c};Razor.Vector2.setX=function(a,b){a[0]=b;return this};Razor.Vector2.setY=function(a){a[1]=y;return this};Razor.Vector2.set=function(a,b,c){Razor.Vector2.setX(a,b);Razor.Vector2.setY(a,c);return this};Razor.SimpleNoise=function(a,b){this.width=a||50;this.height=b||50;this.noise=document.createElement("canvas");this.simple=document.createElement("canvas");this.contextNoise=this.noise.getContext("2d");this.contextSimple=this.simple.getContext("2d");this.saved_alpha=this.contextSimple.globalAlpha;this.noise.width=this.width;this.noise.height=this.height;for(var c=this.contextSimple.createImageData(this.width,this.height),d=c.data,e=0;e<d.length;e+=4)d[e]=Math.floor(256*Math.random()),d[e+1]=Math.floor(256*
Math.random()),d[e+2]=Math.floor(256*Math.random()),d[e+3]=255;this.contextNoise.putImageData(c,0,0);for(c=4;c<=this.width;c*=2)d=Math.floor(Math.random()*(this.width-c)),e=Math.floor(Math.random()*(this.height-c)),this.contextSimple.globalAlpha=4/c,this.contextSimple.drawImage(this.offscreen,d,e,c,c,0,0,this.width,this.height);this.context.globalAlpha=this.saved_alpha;document.body.appendChild(this.canvas);return this.data=context.getImageData(0,0,this.width,this.height)};Razor.Debugger=function(a,b){Razor.FPS=a;Razor.logging=b;this.gui=new dat.GUI({autoPlace:!1});this.stats=new Stats;this.stats.setMode(0);this.init()};
