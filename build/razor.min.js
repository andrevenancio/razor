...
Razor.inherits=function(a,b){var c=function(){};c.prototype=b.prototype;a.superClass=b.prototype;a.prototype=new c;a.prototype.constructor=a};Razor.getBoundingBox=function(a){for(var b="",c=0,d=0;"object"==typeof a&&"undefined"!=typeof a.tagName;)d+=a.offsetTop,c+=a.offsetLeft,b=a.tagName.toUpperCase(),"BODY"==b&&(a=0),"object"==typeof a&&"object"==typeof a.offsetParent&&(a=a.offsetParent);return{x:c,y:d}};Razor.Vector2=function(a,b){var c=new Float32Array(2);Razor.Vector2.set(c,a||0,b||0);return c};Razor.Vector2.setX=function(a,b){a[0]=b;return this};Razor.Vector2.setY=function(a){a[1]=y;return this};Razor.Vector2.set=function(a,b,c){Razor.Vector2.setX(a,b);Razor.Vector2.setY(a,c);return this};Razor.SimpleNoise=function(){this.canvas=document.createElement("canvas");this.canvas_ctx=this.canvas.getContext("2d");this.offscreen=document.createElement("canvas");this.offscreen_ctx=this.offscreen.getContext("2d");this.saved_alpha=this.canvas_ctx.globalAlpha;this.canvas.width=this.offscreen.width=200;this.canvas.height=this.offscreen.height=200;for(var a=this.offscreen_ctx.getImageData(0,0,this.offscreen.width,this.offscreen.height),b=a.data,c=0;c<b.length;c+=4)b[c]=Math.floor(256*Math.random()),
b[c+1]=Math.floor(256*Math.random()),b[c+2]=Math.floor(256*Math.random()),b[c+3]=255;this.offscreen_ctx.putImageData(a,0,0);for(a=4;a<=this.offscreen.width;a*=2){b=Math.floor(Math.random()*(this.offscreen.width-a));c=Math.floor(Math.random()*(this.offscreen.height-a));this.canvas_ctx.globalAlpha=4/a;this.canvas_ctx.drawImage(this.offscreen,b,c,a,a,0,0,this.canvas.width,this.canvas.height);debugger}this.canvas_ctx.globalAlpha=this.saved_alpha;document.body.appendChild(this.canvas);document.body.appendChild(this.offscreen)};Razor.Debugger=function(a,b){Razor.FPS=a;Razor.logging=b;this.gui=new dat.GUI({autoPlace:!1});this.stats=new Stats;this.stats.setMode(0);this.init()};
