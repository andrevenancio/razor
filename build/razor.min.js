...
Razor.SimpleNoise.prototype.setDetail=function(a,b){this.width=a;this.height=b;this.whiteNoiseCanvas.width=this.simpleNoiseCanvas.width=this.width;this.whiteNoiseCanvas.height=this.simpleNoiseCanvas.height=this.height};Razor.SimpleNoise.prototype.setRed=function(a){this.R=a||Math.floor(256*Math.random())};Razor.SimpleNoise.prototype.setGreen=function(a){this.G=a||Math.floor(256*Math.random())};Razor.SimpleNoise.prototype.setBlue=function(a){this.B=a||Math.floor(256*Math.random())};
Razor.SimpleNoise.prototype.generate=function(){this.buildWhiteNoise();this.buildSimpleNoise()};Razor.SimpleNoise.prototype.buildWhiteNoise=function(){for(var a=this.contextSimple.createImageData(this.width,this.height),b=a.data,c=0;c<b.length;c+=4)b[c]=this.R,b[c+1]=this.G,b[c+2]=this.B,b[c+3]=255;this.contextNoise.putImageData(a,0,0)};
